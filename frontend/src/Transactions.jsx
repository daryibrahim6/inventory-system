      ...
      <div className="main-content">
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">Barang Masuk & Keluar</p>
          </div>
        </div>
        ...
        <div className="tabs">
          <button
            ...
            onClick={() => { setActiveTab('in'); handleCancel(); }}
          >
            Barang Masuk
          </button>
          <button
            className={`tab ${activeTab === 'out' ? 'active' : ''}`}
            onClick={() => { setActiveTab('out'); handleCancel(); }}
          >
            Barang Keluar
          </button>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <textarea
                ...
                placeholder={activeTab === 'in' ? 'Contoh: PO-001, Supplier XYZ' : 'Contoh: Departemen IT, Bapak Budi'}
                rows="2"
              />
            </div>
            {selectedItem && activeTab === 'out' && Number(formData.quantity) > selectedItem.stock && (
              <div className="stok-warning">
                Stok tersedia: {selectedItem.stock}, jumlah diminta: {formData.quantity}
              </div>
            )}
            <div className="form-actions">
              ...
              <button
                type="submit"
                className={`btn-primary ${activeTab === 'out' ? 'btn-danger' : 'btn-success'}`}
                disabled={submitting}
              >
