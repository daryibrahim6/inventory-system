...
function Items() {
  ...
  const [formData, setFormData] = useState({
    code: '', name: '', categoryId: '', unit: '', stock: '', price: '',
  });
      ...
      <div className="main-content">
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">{items.length} barang terdaftar</p>
          </div>
          {!showForm && (
          ...
          <div className="form-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-row-3">
                ...
                <div className="form-group">
                  <label>Stok <span className="required">*</span></label>
                  <input
                    type="number"
        ...
        {loading ? (
          ...
          <div className="table-card">
            <table>
              ...
              <tbody>
                {items.length === 0 ? (
                  <tr><td colSpan="8" className="empty">Belum ada barang</td></tr>
                ) : (
                  items.map((item, idx) => (
                    <tr key={item.id}>
                      <td>{idx + 1}</td>
